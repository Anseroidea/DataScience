...
```{r}
attach(Clothing.df)
linreg5 <- lm(Amount ~ (.)^2 + I(Dollar12^2) + I(Freq12 ^ 2) + I(Recency ^ 2) + I(Dollar24 ^ 2) + I(Freq24 ^ 2) + I(ID ^ 2), data = Clothing.df)
summary(linreg5)
```
...
summary(multreg.testpredictors(Clothing.df, linreg5))
